    ...
    >
      <div className="border-border flex flex-col gap-y-2 border-b p-4">
        <div className="flex flex-row gap-x-2">
          ...
          <span className="ml-2 text-xs text-muted-foreground">bash - dev_env</span>
        </div>
      </div>
      <pre className="p-4">
        <code className="grid gap-y-1 max-h-72 overflow-y-auto pr-1 scrollbar-thin scrollbar-track-transparent scrollbar-thumb-border">{wrappedChildren}</code>
      </pre>
    </div>
  )
